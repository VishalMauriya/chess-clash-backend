...
import { BLACK, CHECK, CHECKMATE, DRAW, ERROR, GAME_OVER, INSUFFICIENT_MATERIAL, INVALID_MOVE, MOVE, NONE, RESIGN, STALEMATE, THREEFOLD_REPETITION, TIMEOUT, WHITE } from './messages';
